...
class DemoPage extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        {/* 视频上传部分 */}
        {this.state.videoView == false ? (
          <GridContainer>
            <Card>
              <CardHeader color="primary">
                <h2 className={classes.cardTitleWhite}>上传视频</h2>
              </CardHeader>
              <CardBody>
                <UploadComponent
                  onUpload={(a, b) => this.handleUploadFile(a, b)}
                ></UploadComponent>
              </CardBody>
            </Card>
          </GridContainer>
        ...
        {!!this.state.video_name ? (
          <GridContainer>
            <Card>
              <CardHeader color="primary">
                <h2 className={classes.cardTitleWhite}>模型输出数据</h2>
              </CardHeader>
              <CardBody>
                <AnalysisComponent
